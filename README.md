# BMI-stratified polygenic prediction of type 2 diabetes
...
<ist@megabank.tohoku.ac.jp>), we will share the stored data after assembling the data set after approval of the Ethics Committee and Materials and Information Distribution Review Committee of ToMMo. The PRSs developed for TMM and BBJ-2nd have been released through the [PGS Catalog](https://www.pgscatalog.org) with publication ID PGP000593 and score IDs PGS004615-PGS004620. The PRSs can also be accessed through application at the NBDC with the accession code [hum0197](https://humandbs.biosciencedbc.jp/en/hum0197-latest).


## Contact
Takafumi Ojima: tojima_at_sg.med.osaka-u.ac.jp
